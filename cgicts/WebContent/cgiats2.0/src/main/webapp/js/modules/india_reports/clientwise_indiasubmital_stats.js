;(function(angular){
			...
			"use strict";
			angular.module('clientWise_indiaSubmitalStatsModule',[])
			.controller('clientwise_indiaSubmitalStatsController',function($scope, $http, $state, $location, dateRangeService, $timeout){
				...
				$scope.SubmittalStats = function(){
					...
					if($('#indiaSubmittalStatsRangesId').val() && $('#indiaSubmittalStatsRangesId').val()!=''){
						...
						$scope.obj = {startDate:getDDMMYY_Date(startDate), endDate:getDDMMYY_Date(endDate)};
					}else{
			    		...
			    		$scope.obj = {startDate:viewstartdate, endDate:viewEndDate};
					}
					
					
					var response = $http.post("indiaReports/getClientwiseSubmitalStats",$scope.obj);
					response.success(function(data, status, headers, config){
						...
						var obj = {name:$scope.submittalData[i].Name,
						...
						var totalobj = {name: "Total:",SUBMITTED: $scope.submittalStatsTotal.SUBMITTED, DMREJ: $scope.submittalStatsTotal.DMREJ, ACCEPTED : $scope.submittalStatsTotal.ACCEPTED, INTERVIEWING : $scope.submittalStatsTotal.INTERVIEWING,
