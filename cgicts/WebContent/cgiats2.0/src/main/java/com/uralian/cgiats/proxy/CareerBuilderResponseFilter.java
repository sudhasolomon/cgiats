...
/**
 * 
 * Class that will filters the response from career builder, and launches the
 * download resume process.
 * 
 * @author jbernalm
 */
public class CareerBuilderResponseFilter implements HttpResponseFilter
{
	private static Logger log = LoggerFactory
	    .getLogger(CareerBuilderResponseFilter.class);
	 ...
	 * @param proxy
	 */
	public CareerBuilderResponseFilter(HttpProxy proxy)
	{
		this.proxy = proxy;
	}
	...
	public HttpResponse filterResponse(HttpResponse response)
	{
		...
		CareerBuilderDownloader downloader = new CareerBuilderDownloader(response);
